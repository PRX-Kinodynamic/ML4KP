...
planner = prx.rrt("rrt");
planner_spec = prx.rrt_specification(context.system_group,context.collision_group);
...
planner_query = prx.rrt_query(context.system_group.get_state_space(),context.system_group.get_control_space());
...
# print(planner_spec.distance_function(planner_query.start_state, planner_query.goal_state))
